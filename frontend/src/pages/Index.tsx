...
// interface Filters {
//   districtId: number | null;     // Use ID internally for filtering
//   locationId: number | null;     // Use ID internally for filtering
//   grade: string | null;
//   student: Student | null;
// }
...
const Index: React.FC = () => {
  ...
  const fetchFilteredData = useCallback(async () => {
    ...
    try {
      ...
      // Convert IDs back to names for API requests
      if (districtId) {
  ...
  }, [filters, getApiEndpoint, students]);
